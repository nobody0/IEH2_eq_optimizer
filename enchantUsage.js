// which enchants should be considered for the calculation
//atm empty string get ignored, anything entered in the string will be considered
export let enchantUsage = {
  UnicornKnowledge: "",
  HPAdder: "",
  MPAdder: "",
  ATKAdder: "",
